...
//Punctuation
const int COL =26; const int DASH = 27; const int BRA2 = 28; const int  _ = 29; const int LINE = 30;
const int DOT =31;

//Extra Charchters
const int  FULL =32; const int CHECK = 33; const int AA3 = 34; const int TEMP = 35; 
const int SMILE =36; const int COLDOT = 37;

//Numbers
const int N1 = 38;  const int N2 = 39;  const int N3 = 40;  const int N4 = 41;  const int N5 = 42;
const int N6 = 43;  const int N7 = 44;  const int N8 = 45;  const int N9 = 46;  const int N0 = 47;  
...
const int* letters[] = {_A,_B,_C,_D,_E,_F,_G,_H,_I,_J,_K,_L,_M,_N,_O,_P,_Q,_R,_S,_T,_U,_V,_W,_X,_Y,_Z,_COL,_DASH,_BRA2,__, _LINE, _DOT, _FULL, _CHECK, _A3, _TEMP, _SMILE, _COLDOT, _N1, _N2, _N3, _N4, _N5, _N6, _N7, _N8, _N9, _N0};
...
void loop()
{
  ...
  while (Serial.available() > 0) {
    ...
    if (ch==13)
    {
      ...
      speed--;
    else if (incomingPos<15)
      incomingText[incomingPos++]=ch;
  }
...
void copyIncoming()
{
  ...
  for (i=0;i<15;i++)
    requestString[i] = incomingText[i];
...
int getChar(char charachter){
 ...
 switch(charachter){
  ...
  case '1': returnValue = N1; break;
  case '2': returnValue = N2; break;
  case '3': returnValue = N3; break;
  case '4': returnValue = N4; break;
  case '5': returnValue = N5; break;
  case '6': returnValue = N6; break;
  case '7': returnValue = N7; break;
  case '8': returnValue = N8; break;
  case '9': returnValue = N9; break;
  case '0': returnValue = N0; break;
  }
  return returnValue;
}
